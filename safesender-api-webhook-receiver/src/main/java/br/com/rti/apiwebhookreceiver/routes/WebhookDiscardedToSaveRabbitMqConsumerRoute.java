...
@Component
public class WebhookDiscardedToSaveRabbitMqConsumerRoute extends RouteBuilder {
	...
	@Value("${rabbitmq.webhook.DiscardedToSaveAndSend.queue}")
	public String webhookDiscardedToSaveAndSendQueue;
	...
	public void configure() throws Exception {
		...
		from("spring-rabbitmq:" + exchange + 
				...
				"&queues=" + webhookDiscardedToSaveAndSendQueue).id(this.getClass().getSimpleName())
